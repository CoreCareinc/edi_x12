...
> [!IMPORTANT]
> **Do not update the EDI parsers manually.** It is auto-generated by the scaffolder. Any manual changes will be overwritten. To make changes, update the scaffolder templates instead. [Check](https://github.com/CoreCareinc/edi_x12_scaffold)
...
### Transaction Set
To parse a transaction set, pass the EDI X12 string to the `parse/1` function.
